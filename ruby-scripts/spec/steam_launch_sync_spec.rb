...
def apps_hash(vdf_data)
  VdfNav.dig(vdf_data, "UserLocalConfigStore", "Software", "Valve", "Steam", "apps")
end
...
class ExportPreservationTest < Minitest::Test
  ...
  def test_export_updates_targeted_key
    ...
    assert_equal "gamemoderun %command%",
      VdfNav.dig(reparsed, "UserLocalConfigStore", "Software", "Valve", "Steam", "apps", "294100", "LaunchOptions")
  end
